...
class WarehouseConnector:
    def __init__(self, warehouse_type: str, warehouse_kwargs: dict):
        ...
        # Register event listeners for query execution
        ...
        Engine._bigquery_event_registered = True
    ...
    def _set_kwargs(self):
        if self.warehouse_type == "SNOWFLAKE":
            ...
            self.reading_project = self.warehouse_kwargs.get("project", "")
            self.reading_dataset = self.warehouse_kwargs.get("dataset", "")
