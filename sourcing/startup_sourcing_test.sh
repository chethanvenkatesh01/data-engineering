...
WORKDIR="/opt/airflow/dags/sourcing"  # Update this to your actual working directory
BITBUCKET_BRANCH="develop/test"  # Update this to your actual branch name
BRANCH_ENVIRONMENT="test"  # Update this to your actual environment
...
sudo docker exec sourcing-postgres-1 psql -U airflow -c 'DROP TABLE IF EXISTS alembic_version;'
