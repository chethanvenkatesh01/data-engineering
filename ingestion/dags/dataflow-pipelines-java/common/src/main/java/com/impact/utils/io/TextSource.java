...
class TextSource extends FileBasedSource<String> {
    ...
    protected FileBasedSource<String> createForSubrangeOfFile(
        ...
        return new com.impact.utils.io.TextSource(metadata, start, end, delimiter);
    }

    @Override
    protected FileBasedReader<String> createSingleFileReader(PipelineOptions options) {
        return new com.impact.utils.io.TextSource.TextBasedReader(this, delimiter);
    }
     ...
     * characters.
     *
     * <p>See {@link com.impact.utils.io.TextSource} for further details.
     */
    @VisibleForTesting
    static class TextBasedReader extends FileBasedReader<String> {
        ...
        private TextBasedReader(com.impact.utils.io.TextSource source, byte[] delimiter) {
            super(source);
            ...
            if (startOffset > 0) {
                checkState(
                        ...
                        "%s only supports reading from a SeekableByteChannel when given a start offset"
                                + " greater than 0.",
                        com.impact.utils.io.TextSource.class.getSimpleName());
