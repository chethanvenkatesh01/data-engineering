...
import com.impact.utils.io.BoundedReadFromUnboundedSource;
...
public class ReadWithMetadata {

    /**
     * Returns a new {@code Read.Bounded} {@code PTransform} reading from the given {@code
     * BoundedSource}.
     */
    public static <T> com.impact.utils.io.ReadWithMetadata.Bounded<T> from(BoundedSource<T> source) {
        return new com.impact.utils.io.ReadWithMetadata.Bounded<>(null, source);
    }

    /**
     * Returns a new {@link com.impact.utils.io.ReadWithMetadata.Unbounded} {@link PTransform} reading from the given {@link
     * UnboundedSource}.
     */
    public static <T> com.impact.utils.io.ReadWithMetadata.Unbounded<T> from(UnboundedSource<T, ?> source) {
        return new com.impact.utils.io.ReadWithMetadata.Unbounded<>(null, source);
    }

    /** Helper class for building {@link com.impact.utils.io.ReadWithMetadata} transforms. */
    public static class Builder {
         ...
         * BoundedSource}.
         */
        public <T> com.impact.utils.io.ReadWithMetadata.Bounded<T> from(BoundedSource<T> source) {
            return new com.impact.utils.io.ReadWithMetadata.Bounded<>(name, source);
        }
         ...
         * UnboundedSource}.
         */
        public <T> com.impact.utils.io.ReadWithMetadata.Unbounded<T> from(UnboundedSource<T, ?> source) {
            return new com.impact.utils.io.ReadWithMetadata.Unbounded<>(name, source);
        }
    }
    ...
    public static class Bounded<T> extends PTransform<PBegin, PCollection<T>> {
        ...
        public final PCollection<T> expand(PBegin input) {
            ...
            return input
                    ...
                    .apply(ParDo.of(new com.impact.utils.io.ReadWithMetadata.OutputSingleSource<>(source)))
                    .setCoder(SnappyCoder.of(SerializableCoder.of(new TypeDescriptor<BoundedSource<T>>() {})))
                    .apply(ParDo.of(new com.impact.utils.io.ReadWithMetadata.BoundedSourceAsSDFWrapperFn<>()))
    ...
    public static class Unbounded<T> extends PTransform<PBegin, PCollection<T>> {
        ...
        @VisibleForTesting
        com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn<T, CheckpointMark> createUnboundedSdfWrapper() {
            return new com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn<>(source.getCheckpointMarkCoder());
        }
    ...
    static class BoundedSourceAsSDFWrapperFn<T, BoundedSourceT extends BoundedSource<T>>
        ...
        private static final Logger LOG = LoggerFactory.getLogger(com.impact.utils.io.ReadWithMetadata.BoundedSourceAsSDFWrapperFn.class);
        ...
        public RestrictionTracker<BoundedSourceT, TimestampedValue<T>[]> restrictionTracker(
            ...
            return new com.impact.utils.io.ReadWithMetadata.BoundedSourceAsSDFWrapperFn.BoundedSourceAsSDFRestrictionTracker<>(restriction, pipelineOptions);
        }
    ...
    static class UnboundedSourceAsSDFWrapperFn<OutputT, CheckpointT extends CheckpointMark>
        ...
        private static final Logger LOG = LoggerFactory.getLogger(com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.class);
        ...
        private Coder<com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT>> restrictionCoder;
        ...
        @GetInitialRestriction
        public com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> initialRestriction(
                @Element UnboundedSource<OutputT, CheckpointT> element) {
            return com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction.create(element, null, BoundedWindow.TIMESTAMP_MIN_VALUE);
        }
        ...
        @SplitRestriction
        public void splitRestriction(
                @Restriction com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> restriction,
                OutputReceiver<com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT>> receiver,
                PipelineOptions pipelineOptions)
                throws Exception {
            // The empty unbounded source is trivially done and hence we don't need to output any splits
            // for it.
            if (restriction.getSource() instanceof com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource) {
                return;
            }
            ...
            try {
                for (UnboundedSource<OutputT, CheckpointT> split :
                    ...
                    receiver.output(
                            com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction.create(split, null, restriction.getWatermark()));
                }
            } catch (Exception e) {
        ...
        public RestrictionTracker<
                com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT>, com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceValue<OutputT>[]>
        restrictionTracker(
                @Restriction com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> restriction,
                PipelineOptions pipelineOptions) {
            checkNotNull(restrictionCoder);
            checkNotNull(cachedReaders);
            return new com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceAsSDFRestrictionTracker(
                    restriction, pipelineOptions, cachedReaders, restrictionCoder);
        }

        @ProcessElement
        public ProcessContinuation processElement(
                RestrictionTracker<com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT>, com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceValue[]>
                        tracker,
                ManualWatermarkEstimator<Instant> watermarkEstimator,
                OutputReceiver<ValueWithRecordId<OutputT>> receiver,
                BundleFinalizer bundleFinalizer)
                throws IOException {
            com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> initialRestriction =
                    tracker.currentRestriction();

            com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceValue<OutputT>[] out = new com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceValue[1];
            ...
            com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> currentRestriction =
                    tracker.currentRestriction();
            ...
            // run out of work.
            if (currentRestriction.getSource() instanceof com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource) {
        ...
        @GetRestrictionCoder
        public Coder<com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT>> restrictionCoder() {
            return SnappyCoder.of(
                    new com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestrictionCoder<>(
        ...
        abstract static class UnboundedSourceValue<T> {
            public static <T> com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceValue<T> create(
                    byte[] id, T value, Instant timestamp, Instant watermark) {

                return new AutoValue_ReadWithMetadata_UnboundedSourceAsSDFWrapperFn_UnboundedSourceValue<T>(
        ...
        abstract static class UnboundedSourceRestriction<OutputT, CheckpointT extends CheckpointMark>
            ...
            com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> create(
                    UnboundedSource<OutputT, CheckpointT> source,
                    CheckpointT checkpoint,
                    Instant watermark) {
                return new AutoValue_ReadWithMetadata_UnboundedSourceAsSDFWrapperFn_UnboundedSourceRestriction<>(
        ...
        /** A {@link Coder} for {@link com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction}s. */
        private static class UnboundedSourceRestrictionCoder<
                OutputT, CheckpointT extends CheckpointMark>
                extends StructuredCoder<com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT>> {
            ...
            @Override
            public void encode(
                    com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> value, OutputStream outStream)
            ...
            @Override
            public com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> decode(InputStream inStream)
                    throws CoderException, IOException {
                return com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction.create(
        ...
        private static class EmptyUnboundedSource<OutputT, CheckpointT extends CheckpointMark>
            ...
            private static final com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource INSTANCE = new com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource();
            ...
            private class EmptyUnboundedReader extends UnboundedReader<OutputT> {
                ...
                public UnboundedSource<OutputT, ?> getCurrentSource() {
                    return com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource.INSTANCE;
                }
            }
        }
        ...
        private static class UnboundedSourceAsSDFRestrictionTracker<
            ...
            private final com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> initialRestriction;
            private final PipelineOptions pipelineOptions;
            ...
            UnboundedSourceAsSDFRestrictionTracker(
                    ...
                    Coder<com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT>> restrictionCoder) {
                this.initialRestriction = initialRestriction;
                this.pipelineOptions = pipelineOptions;
            ...
            private Object createCacheKey(
                ...
                return restrictionCoder.structuralValue(
                        com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction.create(
            ...
            private void cacheCurrentReader(
                    com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> restriction) {
                if (!(currentReader instanceof com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource.EmptyUnboundedReader)) {
            ...
            @Override
            public boolean tryClaim(com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceValue<OutputT>[] position) {
                try {
                    if (currentReader == null) {
                    ...
                    position[0] =
                            com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceValue.create(
            ...
            /** The value is invalid if {@link #tryClaim} has ever thrown an exception. */
            @Override
            public com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> currentRestriction() {
                if (currentReader == null) {
                    return initialRestriction;
                }
                ...
                if (!(currentReader instanceof com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource.EmptyUnboundedReader)
                    ...
                    try {
                        ...
                        currentReader = com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource.INSTANCE.createReader(null, checkpointT);
                    }
                }
                return com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction.create(
            ...
            @Override
            public SplitResult<com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT>> trySplit(
                    double fractionOfRemainder) {
                // Don't split if we have the empty sources since the SDF wrapper will be finishing soon.
                com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT> currentRestriction = currentRestriction();
                if (currentRestriction.getSource() instanceof com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource) {
                    return null;
                }
                ...
                SplitResult<com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction<OutputT, CheckpointT>> result =
                        SplitResult.of(
                                com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.UnboundedSourceRestriction.create(
                                        com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource.INSTANCE, null, BoundedWindow.TIMESTAMP_MAX_VALUE),
                                currentRestriction);

                cacheCurrentReader(currentRestriction);
                currentReader =
                        com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource.INSTANCE.createReader(null, currentRestriction.getCheckpoint());
                return result;
            }
            ...
            public void checkDone() throws IllegalStateException {
                checkState(
                        currentReader instanceof com.impact.utils.io.ReadWithMetadata.UnboundedSourceAsSDFWrapperFn.EmptyUnboundedSource.EmptyUnboundedReader,
                        "Expected all records to have been claimed but finished processing "
