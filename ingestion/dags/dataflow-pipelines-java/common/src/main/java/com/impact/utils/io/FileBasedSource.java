...
public abstract class FileBasedSource<T> extends OffsetBasedSource<T> {
    private static final Logger LOG = LoggerFactory.getLogger(com.impact.utils.io.FileBasedSource.class);
    ...
    private final com.impact.utils.io.FileBasedSource.Mode mode;
    ...
    protected FileBasedSource(
        ...
        this.mode = com.impact.utils.io.FileBasedSource.Mode.FILEPATTERN;
     ...
     *
     * @param fileMetadata specification of the file represented by the {@link com.impact.utils.io.FileBasedSource}, in
    ...
    protected FileBasedSource(
        ...
        mode = com.impact.utils.io.FileBasedSource.Mode.SINGLE_FILE_OR_SUBRANGE;
     ...
     *
     * @throws IllegalArgumentException if this source is in {@link com.impact.utils.io.FileBasedSource.Mode#FILEPATTERN} mode.
     */
    public final MatchResult.Metadata getSingleFileMetadata() {
        ...
        checkState(
                ...
                com.impact.utils.io.FileBasedSource.class,
                mode,
                this);
    ...
    public final com.impact.utils.io.FileBasedSource.Mode getMode() {
        return mode;
    }

    @Override
    public final com.impact.utils.io.FileBasedSource<T> createSourceForSubrange(long start, long end) {
        checkArgument(
                mode != com.impact.utils.io.FileBasedSource.Mode.FILEPATTERN, "Cannot split a file pattern based source based on positions");
        checkArgument(
        ...
        com.impact.utils.io.FileBasedSource<T> source = createForSubrangeOfFile(singleFileMetadata, start, end);
        if (start > 0 || end != Long.MAX_VALUE) {
            checkArgument(
                    source.getMode() == com.impact.utils.io.FileBasedSource.Mode.SINGLE_FILE_OR_SUBRANGE,
     ...
     *     which case it will be inferred using {@link com.impact.utils.io.FileBasedSource#getMaxEndOffset}.
     */
    protected abstract com.impact.utils.io.FileBasedSource<T> createForSubrangeOfFile(
     ...
     */
    protected abstract com.impact.utils.io.FileBasedSource.FileBasedReader<T> createSingleFileReader(PipelineOptions options);
    ...
    public final long getEstimatedSizeBytes(PipelineOptions options) throws IOException {
        ...
        if (mode == com.impact.utils.io.FileBasedSource.Mode.FILEPATTERN) {
            long totalSize = 0;
    ...
    @Override
    public final List<? extends com.impact.utils.io.FileBasedSource<T>> split(
        ...
        if (mode == com.impact.utils.io.FileBasedSource.Mode.FILEPATTERN) {
            ...
            List<com.impact.utils.io.FileBasedSource<T>> splitResults = new ArrayList<>(expandedFiles.size());
            for (Metadata metadata : expandedFiles) {
                com.impact.utils.io.FileBasedSource<T> split = createForSubrangeOfFile(metadata, 0, metadata.sizeBytes());
                verify(
                        split.getMode() == com.impact.utils.io.FileBasedSource.Mode.SINGLE_FILE_OR_SUBRANGE,
                        "%s.createForSubrangeOfFile must return a source in mode %s",
                        split,
                        com.impact.utils.io.FileBasedSource.Mode.SINGLE_FILE_OR_SUBRANGE);
            ...
            if (isSplittable()) {
                ...
                List<com.impact.utils.io.FileBasedSource<T>> splits =
                        (List<com.impact.utils.io.FileBasedSource<T>>) super.split(desiredBundleSizeBytes, options);
                return splits;
            } else {
                LOG.debug(
     ...
     *
     * <p>By default, a source in mode {@link com.impact.utils.io.FileBasedSource.Mode#FILEPATTERN} is always splittable, because
     ...
     *
     * <p>By default, a source in {@link com.impact.utils.io.FileBasedSource.Mode#SINGLE_FILE_OR_SUBRANGE} is splittable if it is on a
    ...
    public final BoundedReader<T> createReader(PipelineOptions options) throws IOException {
        ...
        if (mode == com.impact.utils.io.FileBasedSource.Mode.FILEPATTERN) {
            ...
            List<com.impact.utils.io.FileBasedSource.FileBasedReader<T>> fileReaders = new ArrayList<>();
            ...
            return new com.impact.utils.io.FileBasedSource.FilePatternReader(this, fileReaders);
        } else {
    ...
    public final long getMaxEndOffset(PipelineOptions options) throws IOException {
        checkArgument(
                mode != com.impact.utils.io.FileBasedSource.Mode.FILEPATTERN, "Cannot determine the exact end offset of a file pattern");
    ...
    public abstract static class FileBasedReader<T> extends OffsetBasedReader<T> {
         ...
         */
        public FileBasedReader(com.impact.utils.io.FileBasedSource<T> source) {
            super(source);
            checkArgument(
                    source.getMode() != com.impact.utils.io.FileBasedSource.Mode.FILEPATTERN,
                    "FileBasedReader does not support reading file patterns");
        }

        @Override
        public synchronized com.impact.utils.io.FileBasedSource<T> getCurrentSource() {
            return (com.impact.utils.io.FileBasedSource<T>) super.getCurrentSource();
        }

        @Override
        protected final boolean startImpl() throws IOException {
            com.impact.utils.io.FileBasedSource<T> source = getCurrentSource();
            ...
            if (channel instanceof SeekableByteChannel) {
                ...
                checkArgument(
                        source.mode != com.impact.utils.io.FileBasedSource.Mode.SINGLE_FILE_OR_SUBRANGE,
    ...
    private class FilePatternReader extends BoundedReader<T> {
        private final com.impact.utils.io.FileBasedSource<T> source;
        private final List<com.impact.utils.io.FileBasedSource.FileBasedReader<T>> fileReaders;
        final ListIterator<com.impact.utils.io.FileBasedSource.FileBasedReader<T>> fileReadersIterator;

        // Initialized in start
        com.impact.utils.io.FileBasedSource.FileBasedReader<T> currentReader = null;
        //@Nullable com.impact.utils.io.FileBasedSource.FileBasedReader<T> currentReader = null;

        public FilePatternReader(com.impact.utils.io.FileBasedSource<T> source, List<com.impact.utils.io.FileBasedSource.FileBasedReader<T>> fileReaders) {
            this.source = source;
        ...
        @Override
        public com.impact.utils.io.FileBasedSource<T> getCurrentSource() {
            return source;
        }

        @Override
        public com.impact.utils.io.FileBasedSource<T> splitAtFraction(double fraction) {
