...
@Slf4j
public class MapStringToTableRow extends DoFn<String, TableRow> {
    ...
    private Counter totalOutputRowsCounter = Metrics.counter(MapStringToTableRow.class, "totalOutputRows");
    ...
    public MapStringToTableRow() {
        this.delimiter = ",";
        this.replaceSpecialChars = false;
        this.useStandardCsvParser = true;
    }

    public static MapStringToTableRow builder() {
        return new MapStringToTableRow();
    }

    public MapStringToTableRow withDelimiter(String delimiter) {
        this.delimiter = delimiter;
        return this;
    }

    public MapStringToTableRow withSchema(LinkedHashMap<String, String> schema) {
        this.schema = schema;
        return this;
    }

    public MapStringToTableRow withReplaceSpecialChars(boolean replaceSpecialChars) {
        this.replaceSpecialChars = replaceSpecialChars;
        return this;
    }

    public MapStringToTableRow withUseStandardCsvParser(boolean useStandardCsvParser) {
